...
export default function About() {
    ...
    return (
        <Container>
            ...
            <StyledText>Hi! My name is Sophia Howson, and welcome to my bracelet website!</StyledText>
            <StyledText>I've been making friendship bracelets for 6 years now, and it's a craft that I
                really enjoy. I started crafting right before the pandemic and was able to dive into
                it!
            </StyledText>
            <StyledText>This website is a gallery of all of the creations I've made since 2023, which is
            ...
            <StyledText> I'm an aspiring software engineer, so this is a bit of info on how I created this site!
